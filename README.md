...
This project provides a comprehensive analysis of user behavior and monetization trends within a social-gaming application. Utilizing a robust dataset comprising user demographics, in-app events, and subscription details, this report aims to identify key insights into user acquisition, engagement, retention, and premium conversion. The findings are intended to inform strategic decision-making, optimize product features, enhance user experience, and drive sustainable growth.

The analysis focuses on understanding user lifecycle stages, from initial registration and engagement to premium subscription and potential churn, highlighting critical areas for intervention and optimization.
